...
/**
 * Provides defaults for {@link VideoStreamCaptureConfig} in the Camera2 implementation.
 */
public final class VideoStreamCaptureConfigProvider implements ConfigProvider<VideoStreamCaptureConfig> {
    private static final String TAG = "VideoStreamCaptureProvider";

    private final WindowManager mWindowManager;

    public VideoStreamCaptureConfigProvider(@NonNull Context context) {
